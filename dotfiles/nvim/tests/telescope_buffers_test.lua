...
test("setup is idempotent without loading Telescope", function()
    ...
    expect_equal(vim.fn.maparg("<leader>ba", "n"), "<Cmd>PickBuffers<CR>", "all-buffers mapping")
    expect_equal(vim.fn.maparg("<leader>bb", "n"), "<Cmd>PickShownBuffers<CR>", "shown-buffers mapping")
    expect_equal(vim.fn.maparg("<leader>bH", "n"), "<Cmd>PickProtectedHiddenBuffers<CR>", "protected mapping")
    expect_equal(vim.fn.maparg("<leader>bh", "n"), "<Cmd>PickHiddenBuffers<CR>", "hidden-buffers mapping")
end)
